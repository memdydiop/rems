...
new
    #[Layout('layouts.client', ['title' => 'Mes Paiements'])]
    ...
    public function payments()
    {
        ...
        return \App\Models\RentPayment::whereHas('lease', function ($query) use ($client) {
        ...
        <div class="max-w-4xl mx-auto px-4 py-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-zinc-500">Consultez tous vos paiements effectués</p>
                </div>
            </div>
        </div>
    </div>

@extends('layouts.renter', ['title' => 'Payer mon loyer'])
        ...
        <div class="bg-white border-b border-zinc-200">
            <div class="max-w-3xl mx-auto px-4 py-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-zinc-900">Payer mon loyer</h1>
                        <p class="text-zinc-500">Paiement sécurisé en ligne via Paystack</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-3xl mx-auto px-4 py-8">
            ...
            @if($alreadyPaid)
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-zinc-100 p-8 text-center">
                    ...
                    <h2 class="text-2xl font-bold text-zinc-900 mb-2">Loyer déjà réglé !</h2>
                    <p class="text-zinc-500 mb-6">Votre loyer du mois de {{ now()->translatedFormat('F Y') }} est déjà payé.</p>
                    <flux:button variant="filled" href="{{ route('renter.dashboard') }}" icon="arrow-left">
            ...
            @else
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-zinc-100 overflow-hidden">
                    <!-- Lease Info Header -->
                    <div class="bg-gradient-to-r from-indigo-600 to-indigo-700 p-8 text-white">
                    ...
                    <div class="p-8 space-y-6">
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-4 bg-zinc-50 rounded-xl">
                                <span class="text-zinc-500 font-medium">Locataire</span>
                                <span class="font-bold text-zinc-900">{{ $renter->first_name }} {{ $renter->last_name }}</span>
                            </div>
                            <div class="flex items-center justify-between p-4 bg-zinc-50 rounded-xl">
                        ...
                        <!-- Pay Button -->
                        <form action="{{ route('renter.pay.initialize') }}" method="POST">
                            @csrf
                            <button type="submit"

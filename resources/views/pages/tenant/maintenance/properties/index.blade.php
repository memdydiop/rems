...
new #[Layout('layouts.app', ['title' => 'Maintenance'])] class extends Component {
    ...
    {
        $baseQuery = MaintenanceRequest::where('category', \App\Enums\MaintenanceCategory::Property);
...
<div>
    <x-layouts::content heading="Maintenance (Communs)"
        subheading="Gérez les tickets liés aux parties communes de vos propriétés.">
        <x-slot name="actions">
            <flux:button variant="primary" icon="plus"
                wire:click="$dispatch('open-modal', { name: 'property-create-maintenance' })">
                Nouveau Ticket
            </flux:button>
        </x-slot>
                                    ...
                                    <flux:menu>
                                        @if($request->isEditable())
                                            <flux:menu.item icon="pencil-square"
                                                wire:click="$dispatch('property-edit-maintenance', { id: '{{ $request->id }}' })">

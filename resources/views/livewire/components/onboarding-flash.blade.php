<div class="inline-block relative">
    ...
    <div class="{{ !$hasSeen ? 'relative z-[100]' : '' }}">
        ...
        @if(!$hasSeen)
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            <flux:button size="sm" variant="primary"
                                class="w-full bg-[rgb(1,98,232)] hover:bg-[#0152c2] text-white" wire:click="dismiss">
                                Suivant
                            </flux:button>
                        </div>
                    </div>
            ...
            <div
                class="absolute inset-x-[-8px] inset-y-[-8px] border-2 border-[rgb(1,98,232)] rounded-xl animate-ping opacity-30 pointer-events-none">
            </div>
        @endif
    </div>
</div>
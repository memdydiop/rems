...
>
    ...
    <div
        x-ref="name"
        @class([
            'cursor-default select-none truncate whitespace-nowrap text-sm text-zinc-500  font-medium',
            '[[data-flux-input-group]_&]:flex-1 [[data-flux-input-group]_&]:border-e [[data-flux-input-group]_&]:border-y [[data-flux-input-group]_&]:shadow-xs [[data-flux-input-group]_&]:border-zinc-200  [[data-flux-input-group]_&]:px-4 [[data-flux-input-group]_&]:bg-white  [[data-flux-input-group]_&]:flex [[data-flux-input-group]_&]:items-center 
        ])
        aria-hidden="true"
    >
        {!! __('No file chosen') !!}

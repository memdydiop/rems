...
$classes = Flux::classes()
    ->add('h-10 py-2 px-3 w-full rounded-lg disabled:shadow-none  appearance-none text-base sm:text-sm leading-[1.375rem] bg-zinc-800/5   text-zinc-700 placeholder-zinc-500 disabled:placeholder-zinc-400    border-0 relative flex items-center gap-3')
...
<flux:tooltip :position="$tooltipPosition" :class="$tooltipClasses">
    ...
    >
        ...
        <div class="in-data-flux-sidebar-collapsed-desktop:hidden block self-center text-start flex-1 font-medium text-zinc-400 ">
            {{ $placeholder }}
        </div>

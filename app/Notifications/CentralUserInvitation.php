...
class CentralUserInvitation extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        $url = route('central.invitation.accept', [
            'token' => $this->token,
        ]);

        return (new MailMessage)
            ->subject('Invitation to PMS Administration')
            ->greeting('Hello!')
            ->line('You have been invited to join the Central Administration team.')
